...
<img src="../../../Main Project/Computer-Vison/NoteBook/image/v2-6d90d43638dd0807f69c95845254524c_b.jpg" alt="img" style="zoom:80%;" />
...
融合CenterTrack和JDE，选用了DLA34（Deep Layer Aggregation，**深层聚合算子**）的主干网络结构，一共三个输出分别用来预测目标的中心点位置，目标中心点的偏移，目标的BBox尺寸。本文还发现**低维特征实际上对MOT更好**，**因为它的训练图像比ReID少**，**学习低维特征有助于减少过拟合小数据的风险，并提高跟踪的稳健性。**（数据少，网络参数要少）
